            ...
            <div className="about-content padd-15">
              <div className="row">
                <div className="about-text padd-15">
                  <h2>
                    I am Sumal a <span>Software developers</span>
                  </h2>
                  <p>
                    Hi! My name is Sumal. I am a Software developer, and I am
              ...
              <div className="row">
                <div className="personal-info padd-15">
                  <div className="row">
                    ...
                    <div className="info-item padd-15">
                      <p>
                        Email : <span>sumalnadira123@gmail.com</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                        Degree : <span>BSc ICT</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                        Phone : <span>076 5840515</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                        City : <span>Nugegoda</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                  ...
                  <div className="row">
                    <div className="buttons padd-15">
                      <a
                        href="https://drive.google.com/file/d/1p9nHpPTU1ho8JApPEpq7jr_xHS1RqPjp/view?usp=sharing"
                        target="_target"
                        className="btn"
                      >
                        Download CV
                    ...
                    <div className="timeline-box padd-15">
                      <div className="timeline shadow-dark">
                        ...
                        <div className="timeline-item">
                          ...
                          undergraduate (BSc. ICT)
                          </h4>
                          <p className="timeline-text">
                          From 2021 I started studying IT degree,
                          where I am learning react, java, python, 
                        ...
                        <div className="timeline-item">
                          <div className="circle-dot" />
                          <h6 className="timeline-date">
                            <i className="fa fa-calendar" /> 2017 to 2019
                          </h6>
                          <h4 className="timeline-title">
                            Secondary School Certificate
                          </h4>
                          <p className="timeline-text">
                            In 2020 I passed GCE A/L Exam from Art Group with
                            Z-score 1.61. (A2 | B1). 
                            My school name was MR/ Urubokka National School...
                          </p>
                        </div>
                        {/* Timeline Item end */}
                      </div>
                    ...
                    <div className="timeline-box padd-15">
                      <div className="timeline shadow-dark">
                        ...
                        <div className="timeline-item">
                          ...
                          <p className="timeline-text">
                            From 2021 I am woking on Graphics Design. The
